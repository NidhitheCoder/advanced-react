    ...
    <div className="w-screen bg-dark">
      ...
      <div className='w-2/4 mx-auto grid grid-cols-3 gap-4 py-4'>
        {list.map((recommentItem)=> (
          <div key={recommentItem.title} className='w-full h-96 overflow-hidden rounded-lg bg-light text-white'>
            ...
            <div className="p-4 overflow-hidden">
              ...
              <p className="text-ellipsis overflow-hidden">{recommentItem.subtitle}</p>
            </div>
          </div>
        ))}
      </div>
